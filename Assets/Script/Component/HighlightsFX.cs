...
namespace NTUT.CSIE.GameDev.Component
{
    ...
    public class HighlightsFX : MonoBehaviour
    {
        ...
        #region public vars
        public Shader _Highlight, _MobileBlur;
        ...
        {
            var list = new List<Renderer> { renderer };
            AddRenderers(list);
        }
        ...
        private void Awake()
        {
            ...
            m_highlightMaterial = new Material(_Highlight);
            m_blurMaterial = new Material(_MobileBlur);
